...
const VISION_MODEL_ID = process.env.MODEL_ID_IMAGE_BEDROCK || 'amazon.nova-pro-v1:0';
...
const GARMENT_EXTRACTION_USER_PROMPT_ORIGINAL = `Analyze this product image and extract all garment attributes.
...
let GARMENT_EXTRACTION_USER_PROMPT = `Analyze this product image and extract all garment attributes.
...
const GARMENT_EXTRACTION_TOOL = {
    toolSpec: {
        name: "extract_garment_attributes",
        description: "Extract and return structured garment attributes from product image",
        inputSchema: {
            json: {
                type: "object",
                properties: {
                    ...
                    neckline_type: {
                        type: ["string", "null"],
                        enum: ["v_neck", "crew_neck", "scoop_neck", "boat_neck", "square_neck", "sweetheart", "off_shoulder", "halter", "turtleneck", "mock_neck", "cowl_neck", "keyhole", "wrap_surplice", "asymmetric", "one_shoulder", "strapless", "collared", "henley", "peter_pan", "mandarin", "plunging", null]
                    },
                    neckline_depth: {
                        type: ["string", "null"],
                        enum: ["shallow", "medium", "deep", "plunging", null]
                    },
                    hemline_position: {
                        type: ["string", "null"],
                        enum: ["mini", "above_knee", "at_knee", "below_knee", "midi", "tea_length", "ankle", "maxi", "floor_length", "high_low", null]
                    },
                    sleeve_type: {
                        type: ["string", "null"],
                        enum: ["sleeveless", "spaghetti_strap", "cap", "short", "elbow", "three_quarter", "full_length", "bell", "puff", "raglan", "set_in", "dolman", "flutter", "cold_shoulder", "bishop", "lantern", "leg_of_mutton", "off_shoulder", null]
                    },
                    silhouette_type: {
                        type: ["string", "null"],
                        enum: ["a_line", "fit_and_flare", "sheath", "bodycon", "shift", "wrap", "mermaid", "cocoon", "peplum", "empire", "column", "tent", "princess_seam", "dropped_waist", "tiered", "asymmetric", null]
                    },
                    waist_position: {
                        type: ["string", "null"],
                        enum: ["empire", "natural", "drop", "low", "undefined", "elasticized", null]
                    },
                    waist_definition: {
                        type: ["string", "null"],
                        enum: ["defined", "semi_defined", "undefined", null]
                    },
                    fit_category: {
                        type: ["string", "null"],
                        enum: ["tight", "fitted", "semi_fitted", "relaxed", "loose", "oversized", null]
                    },
                    color_primary: {
                        type: ["string", "null"],
                        description: "Primary color name (e.g., 'red', 'navy blue', 'forest green')"
                    },
                    color_value: {
                        type: ["string", "null"],
                        enum: ["very_dark", "dark", "medium_dark", "medium", "medium_light", "light", "very_light", null]
                    },
                    pattern_type: {
                        type: ["string", "null"],
                        enum: ["solid", "horizontal_stripes", "vertical_stripes", "diagonal", "chevron", "polka_dot", "floral_small", "floral_large", "plaid", "abstract", "animal_print", "colorblock", "geometric", "paisley", "houndstooth", "gingham", null]
                    },
                    fabric_apparent_weight: {
                        type: ["string", "null"],
                        enum: ["very_light", "light", "medium", "heavy", null]
                    },
                    fabric_sheen: {
                        type: ["string", "null"],
                        enum: ["matte", "subtle_sheen", "moderate_sheen", "shiny", null]
                    },
                    fabric_drape: {
                        type: ["string", "null"],
                        enum: ["stiff", "structured", "fluid", "very_drapey", null]
                    },
                    has_darts: {
                        type: ["boolean", "null"]
                    },
                ...
                required: ["garment_type", "neckline_type", "neckline_depth", "hemline_position", "sleeve_type", "silhouette_type", "waist_position", "waist_definition", "fit_category", "color_primary", "color_value", "pattern_type", "fabric_apparent_weight", "fabric_sheen", "fabric_drape", "has_darts", "has_seaming"]
            }
        }
    }
};

// Flag to toggle between tool-based and prompt-based extraction
const USE_TOOL_EXTRACTION = true;
...
async function extractFromSingleImage(imageSource) {
        ...
        messages: [
            {
                ...
                content: [
                    {
                        image: {
                            format: 'jpeg', // Always JPEG after sharp resize
                            source: {
                                bytes: Buffer.from(imageBase64, 'base64')
                            }
                        }
                    },
                    { text: "Analyze this product image and extract all visible garment attributes using the extract_garment_attributes tool." }
                ]
            }
        ],
        inferenceConfig: {
    ...
    // Use tool-based extraction for guaranteed structured output
    if (USE_TOOL_EXTRACTION) {
        input.toolConfig = {
            tools: [GARMENT_EXTRACTION_TOOL],
            toolChoice: {
                tool: {
                    name: "extract_garment_attributes"
                }
    ...
    if (USE_TOOL_EXTRACTION) {
        ...
        garmentAttributes = toolUse.toolUse.input;
        rawResponse = JSON.stringify(garmentAttributes, null, 2);
    } else {
        ...
        garmentAttributes = JSON.parse(jsonMatch[0]);
    }
...
export function flattenAttributes(attributes) {
    ...
    let out =  {
        ...
        garment_length_inches: attributes.garment_length_inches ?? null,
        sleeve_length_inches: attributes.sleeve_length_inches ?? null,
...
async function main() {
    ...
    if (result.success) {
        ...
        // flat = reAssignNullAttributes(flat);
